...
static inline void print_hex(unsigned int value, int digits, unsigned char color) {
  void* args[] = {(void*)(unsigned int)value, (void*)(unsigned int)digits, (void*)(unsigned int)color};
  display_op_arr[OP_PRINT_HEX](&display, args);
}
