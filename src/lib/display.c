...
static void print_hex_op(display_t* disp, void* arg) {
  void** args = (void**)arg;
  unsigned int value = (unsigned int)args[0];
  int digits = (int)(unsigned int)args[1];
  unsigned char color = (unsigned char)(unsigned int)args[2];

  const char* hex_chars = "0123456789ABCDEF";

  void* prefix_args[] = {(void*)(unsigned int)'0', (void*)(unsigned int)color};
  display_op_arr[OP_PUTCHAR](disp, prefix_args);

  void* x_args[] = {(void*)(unsigned int)'x', (void*)(unsigned int)color};
  display_op_arr[OP_PUTCHAR](disp, x_args);
  ...
  while (i >= 0) {
    ...
    started = 1;
    void* char_args[] = {(void*)(unsigned int)hex_chars[nibble], (void*)(unsigned int)color};
    display_op_arr[OP_PUTCHAR](disp, char_args);
    i--;
  }

  if (!started) {
    void* zero_args[] = {(void*)(unsigned int)'0', (void*)(unsigned int)color};
    display_op_arr[OP_PUTCHAR](disp, zero_args);
  }
}
